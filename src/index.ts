...
import { handleGetQRcode, sessionData, SessionData } from './updateSession';
...
const createLive = (sess: SessionData = null) => {
  getDanmaku(messageList, sess).then((retLiveClient) => {
